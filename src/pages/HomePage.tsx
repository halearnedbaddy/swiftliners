            ...
            <div className="mb-12 relative">
              <div className="flex items-center justify-center gap-4 md:gap-8">
                ...
                <div className="flex flex-col items-center">
                  ...
                  <span className="text-white text-xs mt-2 font-medium">Buyer</span>
                </div>
                ...
                <div className="flex flex-col items-center relative">
                  ...
                  <span className="text-white text-xs mt-2 font-bold">ESCROW</span>
                ...
                <div className="flex flex-col items-center">
                  ...
                  <span className="text-white text-xs mt-2 font-medium">Seller</span>
                </div>
              </div>
            </div>
            ...
            <div className="mb-12 flex items-center justify-center gap-6">
              ...
              <div className="group relative">
                <div className="w-32 h-40 md:w-40 md:h-48 rounded-null-2xl bg-[#254E58]/20 border border-[#5d2ba3]/30 flex flex-col items-center justify-center backdrop-blur-sm p-4 transition-all duration-300 hover:border-[#5d2ba3]/60 hover:scale-105">
                  ...
                  <span className="text-white text-sm font-semibold">Storefront</span>
                  <span className="text-white/70 text-xs mt-1">Full catalog</span>
                </div>
              </div>
              ...
              <div className="group relative">
                <div className="w-32 h-40 md:w-40 md:h-48 rounded-null-2xl bg-[#254E58]/20 border border-[#5d2ba3]/30 flex flex-col items-center justify-center backdrop-blur-sm p-4 transition-all duration-300 hover:border-[#5d2ba3]/60 hover:scale-105">
                  ...
                  <span className="text-white text-sm font-semibold">Payment Link</span>
                  <span className="text-white/70 text-xs mt-1">Quick sales</span>
                </div>
              </div>
            </div>
